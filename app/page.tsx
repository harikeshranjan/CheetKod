      ...
      <section className="relative pt-24 pb-16 lg:pt-32 lg:pb-24">
        ...
        <div className="relative w-full max-w-7xl mx-auto px-4 lg:px-8">
          <div className="w-full max-w-5xl mx-auto text-center">
            ...
            {/* Main Heading */}
            <h1 className="font-bold text-3xl md:text-4xl leading-tight sm:text-5xl lg:text-6xl text-gray-900 dark:text-white mb-6">
              Master
      ...
      <section className="py-16 lg:py-24 bg-gray-50/50 dark:bg-neutral-900/50">
        <div className="w-full max-w-7xl mx-auto px-4 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="group p-8 bg-white/80 dark:bg-neutral-800/80 rounded-2xl border border-gray-200/50 dark:border-neutral-700/50 backdrop-blur-sm hover:shadow-xl transition-all duration-300 cursor-pointer">
              <div className="w-12 h-12 bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
                <LayoutPanelTop className="w-5 h-5 inline-block" />
              </div>
